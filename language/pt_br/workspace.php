...
// 1. Interface Principal e Branding (mais importante: elementos centrais e visíveis da UI)
...
// 2. Ações Principais e Status do Editor (frequentes: interações diárias e feedback imediato)
...
'WSP_RENAME' => 'Renomear',
'WSP_COPIED' => 'Copiado!',
// 3. Gerenciamento de Projetos e Arquivos (essencial: criação e navegação básica)
...
// 4. Ferramentas Avançadas (úteis, mas secundárias: diff e busca/substituição)
...
// 5. Confirmações (importantes para UX segura, mas não centrais)
...
// 6. Mensagens de Erro e Segurança (críticos, mas menos frequentes em uso normal)
