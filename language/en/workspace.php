...
$lang = array_merge($lang, array(
	...
	'WSP_UPLOAD_WAF_BLOCKED' => 'Hosting/CDN security blocked the upload of %s (HTTP %d) after automatic retries. Try again later or allow the phpBB /workspace/upload route in the hosting firewall/CDN.',
	'WSP_UPLOAD_TOO_LARGE' => 'The upload request is too large for the server: %s',
	'WSP_UPLOAD_HTTP_ERROR' => 'Upload failed for %s (HTTP %d).',
	'WSP_UPLOAD_BATCH_FINISHED_ERRORS' => 'Upload finished with %d file(s) that could not be sent.',
	...
	'WSP_WAF_CHALLENGE'         => 'Hosting/CDN security blocked this read request (HTTP %s). The Workspace retried automatically. If it persists, allow the phpBB /workspace/* routes in the hosting firewall/CDN.',
	'WSP_ERROR_TREE_REFRESH'      => 'Could not refresh the project tree after two attempts. Check the connection and try again.',
...
$lang = array_merge($lang, [
	'WSP_DOWNLOAD_SUBMISSION_PACKAGE' => 'Generate phpBB ZIP',
	'WSP_EXPORT_VALIDATION_REPORT' => 'Export report',
	'WSP_EXPORT_VALIDATION_NO_REPORT' => 'Run validation before exporting the report.',
	'WSP_EXPORT_VALIDATION_DONE' => 'Validation report downloaded.',
	'WSP_VALIDATOR_RUN_EXTDB_FIRST' => 'Run the phpBB Extension DB validation with zero errors before generating the submission ZIP.',
	'WSP_ERR_SUBMISSION_COMPOSER' => 'Cannot generate the submission package: composer.json must contain a valid name in vendor/extension format.',
	'WSP_ERR_UPDATE_FAILED' => 'The requested update could not be completed.',
	'WSP_ERR_CREATE_FAILED' => 'The requested item could not be created.',
	...
	'WSP_VALIDATOR_SCORE' => 'submission score',
	'WSP_VALIDATOR_ERRORS' => 'errors',
	'WSP_VALIDATOR_WARNINGS' => 'warnings',
	'WSP_VALIDATOR_NOTICES' => 'info',
...
$lang = array_merge($lang, [
	...
	'WSP_VALIDATOR_APPLY_SAFE_FIXES_COUNT' => 'Apply safe fixes (%d)',
	'WSP_VALIDATOR_NO_SAFE_FIXES' => 'No safe fixes',
	'WSP_VALIDATOR_SAFE_FIXES_HINT' => 'Applies only deterministic fixes and saves the previous file content in version history.',
	'WSP_VALIDATOR_NO_SAFE_FIXES_HINT' => 'No deterministic fix is listed in the report; click to run the defensive safe-fix scan and confirm that nothing can be changed automatically.',
...
$lang = array_merge($lang, [
	...
	'WSP_ACCESS_GROUP_SETUP_SHORT' => 'Configure access',
	'WSP_ACCESS_GROUP_CONFIGURE' => 'Configure Workspace access group',
	'WSP_ACCESS_GROUP_REQUIRED' => 'Required',
	'WSP_ACCESS_GROUP_NOT_CONFIGURED' => 'Workspace access group is not configured.',
	'WSP_ACCESS_GROUP_NAME' => 'Workspace access group name',
	'WSP_ACCESS_GROUP_DEFAULT_NAME' => 'Workspace users',
	'WSP_ACCESS_GROUP_HELP' => 'Define the phpBB group that will receive the global Workspace access permissions. Project roles still control each project separately.',
	'WSP_ACCESS_GROUP_CREATE_OR_FIND' => 'Create/find group',
	'WSP_ACCESS_GROUP_CONFIGURED' => 'Workspace access group configured.',
	'WSP_ACCESS_GROUP_CREATED' => 'Workspace access group created.',
	'WSP_ACCESS_GROUP_FOUND' => 'Existing Workspace access group found.',
	'WSP_ACCESS_GROUP_DESCRIPTION' => 'Users allowed to access Mundo phpBB Workspace. Configure permissions in the ACP.',
	'WSP_ACCESS_GROUP_PERMISSIONS_TITLE' => 'After this, configure group permissions in the ACP',
	'WSP_ACCESS_GROUP_PERMISSIONS_NOTICE' => 'Go to ACP > Permissions > Group permissions, choose this group, and grant only the Workspace permissions you want. The extension does not grant phpBB ACLs automatically.',
	'WSP_ACCESS_GROUP_NOT_CONFIGURED_AFTER_ADD' => 'The user was added to the project, but the Workspace access group is not configured. They may still lack global Workspace permission.',
	'WSP_ERR_ACCESS_GROUP_CREATE_FAILED' => 'Could not create or locate the Workspace access group.',
	'WSP_ACCESS_GROUP_PERM_ACCESS' => 'Can access the Workspace',
	'WSP_ACCESS_GROUP_PERM_VIEW' => 'Can view allowed projects',
	'WSP_ACCESS_GROUP_PERM_UPLOAD' => 'Can upload files, if desired',
	'WSP_ACCESS_GROUP_PERM_DOWNLOAD' => 'Can download/export, if desired',
	'WSP_ACTIVITY_ACCESS_GROUP_ADDED' => 'was added to the Workspace access group',
]);

$lang = array_merge($lang, [
	'WSP_LOG_FOLDER_DELETED' => 'Folder deleted: %s',
]);

$lang = array_merge($lang, [
	'WSP_EPV_OFFICIAL' => 'Official phpBB EPV',
	'WSP_EPV_PASS' => 'PASS',
	'WSP_EPV_FAIL' => 'FAILED',
	'WSP_EPV_UNAVAILABLE' => 'UNAVAILABLE',
	'WSP_EPV_VERSION' => 'EPV version',
	'WSP_EPV_FATALS' => 'fatal',
	'WSP_EPV_INSTALL' => 'Local EPV installation required',
	'WSP_EPV_INSTALL_LOCATION' => 'Recommended directory',
	'WSP_EPV_RAW_OUTPUT' => 'Show raw official EPV output',
	'WSP_EPV_SUMMARY_NOT_VERIFIED' => 'Official EPV has not been verified yet.',
	'WSP_EPV_SUMMARY_NOT_REQUIRED' => 'Official EPV is not required for this validation scope.',
	'WSP_EPV_SUMMARY_NOT_INSTALLED' => 'The official phpBB validator could not be prepared on this server. Workspace tries to set it up automatically on the first validation; no terminal or Composer command is required.',
	'WSP_EPV_SUMMARY_PROCESS_UNAVAILABLE' => 'Symfony Process is unavailable, so Workspace cannot execute the local EPV safely.',
	'WSP_EPV_SUMMARY_PROC_OPEN_DISABLED' => 'proc_open() is disabled in PHP, so Workspace cannot execute the official EPV.',
	'WSP_EPV_SUMMARY_PHP_CLI_MISSING' => 'A PHP CLI executable could not be located for the official EPV.',
	'WSP_EPV_SUMMARY_TEMP_FAILED' => 'Workspace could not create a temporary directory for the official EPV.',
	'WSP_EPV_SUMMARY_PASS' => 'Official EPV passed with no fatal errors, errors or warnings.',
	'WSP_EPV_SUMMARY_COUNTS' => 'Official EPV reported %1$d fatal, %2$d error(s), %3$d warning(s) and %4$d notice(s).',
	'WSP_EPV_SUMMARY_MISSING' => 'Official EPV did not return its validation summary. Review the raw EPV output before submitting the extension.',
	'WSP_EPV_SUMMARY_INTERNAL_ERROR' => 'The official EPV stopped because of an internal execution error. This is an EPV runtime failure, not a successful validation; review the EPV message before submitting the extension.',
	'WSP_EPV_SUMMARY_EXIT_CODE' => 'Official EPV process failed with exit code %d. Review the EPV output.',
	'WSP_EPV_SUMMARY_EXCEPTION' => 'Official EPV could not complete: %s',
	'WSP_EPV_SUMMARY_PROCESS_START_FAILED' => 'The official EPV process could not be started: %s',
	'WSP_EPV_SUMMARY_TIMEOUT' => 'The official EPV exceeded the %d-second execution limit.',
	'WSP_EPV_TEMP_UNSAFE_PATH' => 'Unsafe project path cannot be materialized for EPV: %s',
	'WSP_EPV_TEMP_DIR_FAILED' => 'Unable to create a temporary project directory for EPV.',
	'WSP_EPV_TEMP_FILE_FAILED' => 'Unable to materialize project file for EPV: %s',
]);

$lang = array_merge($lang, [
	'WSP_EPV_SETUP_TITLE' => 'Official EPV setup',
	'WSP_EPV_SETUP_DESCRIPTION' => 'Workspace can install and prepare the official phpBB EPV automatically. No Git or global Composer installation is required.',
	'WSP_EPV_INSTALL_BUTTON' => 'Install official EPV',
	'WSP_EPV_UPDATE_BUTTON' => 'Update / repair EPV',
	'WSP_EPV_INSTALL_CONFIRM' => 'Workspace will download the official phpbb/epv repository from GitHub and install its dependencies under phpBB/tools/epv. Continue?',
	'WSP_EPV_INSTALLING' => 'Installing official EPV...',
	'WSP_EPV_INSTALL_SUCCESS' => 'Official phpBB EPV was installed successfully.',
	'WSP_EPV_INSTALL_PERMISSION' => 'Only an administrator with permission to manage extensions can install or update the official EPV.',
	'WSP_EPV_INSTALL_REQUIREMENTS' => 'Automatic EPV setup is not available because one or more server requirements are missing. Review the environment checks shown by Workspace.',
	'WSP_EPV_INSTALL_TOOLS_DIR_FAILED' => 'Workspace could not create the phpBB/tools directory.',
	'WSP_EPV_INSTALL_STAGE_FAILED' => 'Workspace could not create the temporary EPV installation directory.',
	'WSP_EPV_INSTALL_DOWNLOAD_FAILED' => 'The official EPV package could not be downloaded: %s',
	'WSP_EPV_INSTALL_ARCHIVE_INVALID' => 'The downloaded archive is not a valid official phpbb/epv package.',
	'WSP_EPV_INSTALL_COMPOSER_FAILED' => 'EPV dependencies could not be installed. Composer output: %s',
	'WSP_EPV_INSTALL_REPLACE_FAILED' => 'Workspace could not replace the local EPV installation. The previous installation was preserved when possible.',
	'WSP_EPV_INSTALL_VERIFY_FAILED' => 'The EPV installation finished, but Workspace could not verify the EPV executable.',
	'WSP_EPV_INSTALL_EXCEPTION' => 'Automatic EPV setup failed: %s',
	'WSP_EPV_INSTALL_NO_OUTPUT' => 'No Composer output was returned.',
	'WSP_EPV_INSTALL_WRITE_FAILED' => 'Workspace could not write the EPV download file.',
	'WSP_EPV_INSTALL_NETWORK_FAILED' => 'The server could not download the official EPV package over HTTPS.',
	'WSP_EPV_INSTALL_ARCHIVE_SIZE' => 'The EPV download has an unexpected size and was rejected.',
	'WSP_EPV_SETUP_ADMIN' => 'Extension administrator permission',
	'WSP_EPV_SETUP_PROC_OPEN' => 'PHP process execution (proc_open)',
	'WSP_EPV_SETUP_PHP_CLI' => 'PHP command-line executable',
	'WSP_EPV_SETUP_ZIP' => 'PHP ZIP support',
	'WSP_EPV_SETUP_DOWNLOAD' => 'HTTPS download support',
	'WSP_EPV_SETUP_WRITABLE' => 'Writable phpBB tools directory',
	'WSP_EPV_SETUP_OK' => 'OK',
	'WSP_EPV_SETUP_MISSING' => 'Missing',
	'WSP_EPV_SETUP_SOURCE' => 'Official source: phpbb/epv on GitHub',
	'WSP_EPV_SETUP_RETRY' => 'After installation, Workspace will run the validator again automatically.',
]);

$lang = array_merge($lang, [
	'WSP_EPV_INSTALL_HTTP_ERROR' => 'HTTP request failed with status %d.',
]);
