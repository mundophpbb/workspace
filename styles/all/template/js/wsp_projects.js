 ...
 * Version 4.5 (SSOT + ACL granular + lock-aware + modal open-project respects CAN_OPEN)
 */
WSP.projects = {
 ...
 */
	...
	bindEvents: function ($) {
		...
		// Open project (switcher modal) — respects CAN_OPEN/LOCKED via data-attrs
		...
		// Click a switcher item — blocks when it cannot be opened
		...
		// Create file (backend requires rename_move in file_controller add_file)
		...
		// Workspace UI logic.
		// =====================================================
		// New file at root (backend requires rename_move)
