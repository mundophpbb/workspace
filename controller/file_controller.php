...
class file_controller extends base_controller
{
    ...
    public function save_file()
    {
        ...
        if ($row_old && isset($this->project_repo) && method_exists($this->project_repo, 'get_file_lock'))
        {
            ...
            if ($lock && (int) ($lock['user_id'] ?? 0) !== (int) $this->user->data['user_id'] && !$this->auth->acl_get('u_workspace_manage'))
            {
    ...
    /**
     * Lista comentarios de revisao do arquivo atual.
     */
    ...
    /**
     * Adiciona comentario de revisao ao arquivo atual.
     * Requer view do projeto; leitores podem comentar sem editar arquivo.
     */
    ...
    /**
     * Remove comentario. Apenas autor, gestor do projeto ou admin global.
     */
    ...
    /**
     * Retorna o estado de revisao/aprovacao do arquivo atual.
     */
    ...
    /**
     * Envia o arquivo para revisao. Colaboradores podem solicitar revisao.
     */
    ...
    /**
     * Aprova ou solicita ajustes em um arquivo. Requer gestao do projeto.
     */
    ...
    /**
     * Lista historico de versoes/snapshots do arquivo atual.
     */
    ...
    /**
     * Abre uma versao anterior em modo de visualizacao.
     */
    ...
    /**
     * Restaura uma versao anterior do arquivo.
     */
    ...
    public function unlock_file()
    {
        ...
        $can_force = $this->auth->acl_get('u_workspace_manage') || !empty($access['can_manage']);
